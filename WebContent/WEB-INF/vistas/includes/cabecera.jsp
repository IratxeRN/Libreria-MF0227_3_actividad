    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
        <li class="nav-item active">
            <a class="nav-link" href="index">Presentación<span class="sr-only">(current)</span></a>
        </li>
        <c:choose>
        <c:when test="${sessionScope.usuario != null}">
        <li class="nav-item">
          <a class="nav-link" href="admin/gestion">Gestion de Libros</a>
        </li>
        </c:when>
        </c:choose>
      </ul>
      ...
      <ul class="navbar-nav">
      	...
      	<c:choose>
			<c:when test="${sessionScope.usuario == null}">
	      	...
	      	<c:otherwise>
				<li class="navbar-text">@Administrador -
				</li>
